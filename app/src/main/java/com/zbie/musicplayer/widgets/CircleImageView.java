...
public class CircleImageView extends ImageView {
    ...
    private static final boolean DeFAULT_BORDER_OVERRLAY = false;
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderOverlay = ta.getBoolean(R.styleable.CircleImageView_border_overlay, DeFAULT_BORDER_OVERRLAY);
